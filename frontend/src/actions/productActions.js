...
export const createReviewsProduct = (id, product) => async (dispatch, getState) => {
    try {
        dispatch({
        ...
        await axios.post(`/api/products/${id}/reviews`, product, config )
...
export const listProductTop = () => async (dispatch) => {
    try {
        dispatch({
