...
export const getAllFormula = () => async (dispatch) => {
    try {
        dispatch({
            type: GET_ALL_FORMULA_REQUEST
        })
        ...
        dispatch({
            type: GET_ALL_FORMULA_SUCCESS,
            payload: data
        })
    } catch (error) {
        dispatch({
            type: GET_ALL_FORMULA_FAIL,
            payload:
                error.response && error.response.data.message
                    ? error.response.data.message
                    : error.message
