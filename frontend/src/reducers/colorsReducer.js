import {
    COLORS_ADD_FAIL,
    COLORS_ADD_REQUEST,
    COLORS_ADD_SUCCESS, COLORS_DELETE_FAIL,
...
export const colorsDeleteReducer = (state = {}, action) => {
    switch (action.type) {
        case COLORS_DELETE_REQUEST:
            return {loading: true}
        case COLORS_DELETE_SUCCESS:
            return {loading: false, colorsDelete: action.payload}
        case COLORS_DELETE_FAIL:
            return {loading: false, error: action.payload}
        default:
            return state
    }
